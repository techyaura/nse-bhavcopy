...
const options = {
   type: 'csv'  // optional. if not specified, zip file will be downloaded valid TYPES: ['json', 'csv', 'zip']
...
request
  .download({
    month: "JUL", // required (values acn be anything given below under Month CODES)
    year: 2020, // required (values acn be anything given below under YEAR CODES)
